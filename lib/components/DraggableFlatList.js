...
var react_native_reanimated_1 = __importStar(
  require("react-native-reanimated")
);
var CellRendererComponent_1 = __importDefault(
...
function DraggableFlatListInner(props) {
  ...
  var _c = props.dragHitSlop,
    ...
    scrollEnabled =
      _d === void 0 ? constants_1.DEFAULT_PROPS.scrollEnabled : _d,
    _e = props.activationDistance,
    activationDistanceProp =
      _e === void 0 ? constants_1.DEFAULT_PROPS.activationDistance : _e;
  var _f = react_1.useState(null),
    activeKey = _f[0],
    setActiveKey = _f[1];
  var keyExtractor = react_1.useCallback(
    function (item, index) {
  ...
  var onListContentSizeChange = function (w, h) {
    ...
    (_a = props.onContentSizeChange) === null || _a === void 0
      ? void 0
      : _a.call(props, w, h);
  };
  ...
  var renderItem = react_1.useCallback(
    function (_a) {
      var item = _a.item,
        index = _a.index;
  ...
  var resetHoverState = react_1.useCallback(
    function () {
  ...
  var onRelease = function (_a) {
    ...
    isTouchActiveRef.current.native.setValue(0);
    (_b = props.onRelease) === null || _b === void 0
      ? void 0
      : _b.call(props, index);
  };
  var onDragEnd = react_1.useCallback(
    function (_a) {
      var from = _a[0],
        to = _a[1];
  ...
  var onGestureRelease = useNode_1.useNode(
    react_native_reanimated_1.cond(
      ...
      [
        react_native_reanimated_1.call([activeIndexAnim], resetHoverState),
        resetTouchedCell,
      ]
    )
  );
  var onPanStateChange = react_1.useMemo(
    function () {
            ...
            return react_native_reanimated_1.block([
              react_native_reanimated_1.cond(
                react_native_reanimated_1.and(
                  react_native_reanimated_1.neq(state, panGestureState),
                  react_native_reanimated_1.not(disabled)
                ),
                [
                  react_native_reanimated_1.cond(
                    react_native_reanimated_1.or(
                      ...
                      ), // Called on press in on Android, NOT on ios!
              ...
              react_native_reanimated_1.cond(
                react_native_reanimated_1.neq(panGestureState, state),
                [
                  ...
                  react_native_reanimated_1.cond(
                    react_native_reanimated_1.or(
                      react_native_reanimated_1.eq(
                        state,
                        react_native_gesture_handler_1.State.END
                      ),
                      react_native_reanimated_1.eq(
                        state,
                      ...
                      react_native_reanimated_1.eq(
                        state,
                        react_native_gesture_handler_1.State.FAILED
                      )
                    ),
                    onGestureRelease
                  ),
  ...
  var onPanGestureEvent = react_1.useMemo(
    function () {
      return react_native_reanimated_1.event([
        {
          nativeEvent: function (_a) {
            var x = _a.x,
              y = _a.y;
            return react_native_reanimated_1.cond(
              react_native_reanimated_1.and(
                react_native_reanimated_1.greaterThan(activeIndexAnim, -1),
                react_native_reanimated_1.eq(
                  panGestureState,
  ...
  var scrollHandler = react_1.useMemo(
    function () {
  ...
  return react_1.default.createElement(
    draggableFlatListContext_1.default,
    {
      activeKey: activeKey,
      onDragEnd: onDragEnd,
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(ScrollOffsetListener_1.default, {
          ...
          onScrollOffsetChange: function (_a) {
            var _b;
            var offset = _a[0];
            scrollOffsetRef.current = offset;
            (_b = props.onScrollOffsetChange) === null || _b === void 0
              ? void 0
              : _b.call(props, offset);
          },
        }),
        !!props.renderPlaceholder &&
          react_1.default.createElement(PlaceholderItem_1.default, {
...
function DraggableFlatList(props, ref) {
  return react_1.default.createElement(
    propsContext_1.default,
    __assign({}, props),
    react_1.default.createElement(
      animatedValueContext_1.default,
      null,
      react_1.default.createElement(
        refContext_1.default,
        { flatListRef: ref },
        react_1.default.createElement(
