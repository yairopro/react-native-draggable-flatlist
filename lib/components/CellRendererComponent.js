...
function CellRendererComponent(props) {
  ...
  var horizontalAnim = animatedValueContext_1.useAnimatedValues()
    .horizontalAnim;
  ...
  var style = react_1.useMemo(
    function () {
      return {
        transform: [
          {
            translateX: react_native_reanimated_1.cond(
              horizontalAnim,
              translate,
              0
            ),
          ...
          {
            translateY: react_native_reanimated_1.cond(
              horizontalAnim,
              0,
              translate
            ),
  ...
  var updateCellMeasurements = react_1.useCallback(
    function () {
      var _a;
      ...
      var onFail = function () {
        var _a;
        if (
          (_a = propsRef.current) === null || _a === void 0 ? void 0 : _a.debug
        ) {
  ...
  var onCellLayout = react_1.useCallback(
    function (e) {
      updateCellMeasurements();
      onLayout(e);
    },
