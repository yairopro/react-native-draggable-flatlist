...
function PlaceholderItem(_a) {
  ...
  var _e = animatedValueContext_1.useAnimatedValues(),
  ...
  var _g = refContext_1.useRefs(),
    keyToIndexRef = _g.keyToIndexRef,
    propsRef = _g.propsRef;
  var activeKey = draggableFlatListContext_1.useDraggableFlatListContext()
    .activeKey;
  var horizontal = propsContext_1.useProps().horizontal;
  var onPlaceholderIndexChange = react_1.useCallback(
    function (index) {
      var _a, _b;
      (_b = (_a = propsRef.current).onPlaceholderIndexChange) === null ||
      _b === void 0
        ? void 0
        : _b.call(_a, index);
    },
  ...
  react_native_reanimated_1.useCode(function () {
    return react_native_reanimated_1.block([
      react_native_reanimated_1.onChange(
        activeCellSize,
        react_native_reanimated_1.call([activeCellSize], function (_a) {
          var size = _a[0];
      ...
      react_native_reanimated_1.onChange(
        spacerIndexAnim,
        react_native_reanimated_1.call([spacerIndexAnim], function (_a) {
          var i = _a[0];
  ...
  var opacity = useNode_1.useNode(
    react_native_reanimated_1.cond(
      react_native_reanimated_1.greaterThan(spacerIndexAnim, -1),
      1,
      0
    )
  );
  ...
  var activeItem =
    activeIndex === undefined
      ? null
      : (_d = propsRef.current) === null || _d === void 0
      ? void 0
      : _d.data[activeIndex];
  var animStyle =
    ((_b = {
    ...
    (_b.transform = [
      ((_c = {}),
      (_c[translateKey] = react_native_reanimated_1.sub(
        placeholderOffset,
        scrollOffset
      )),
      _c),
