...
var set = react_native_reanimated_1.default.set,
...
var proc = constants_1.isWeb
  ? function (cb) {
      return cb;
    }
  : react_native_reanimated_1.default.proc;
  ...
  return block([
    cond(
      ...
      [
        ...
        cond(react_native_reanimated_1.not(disabled), [
          // Determine whether this cell is after the active cell in the list
          set(
            isAfterActive,
            exports.getIsAfterActive(currentIndex, activeIndex)
          ),
        ...
        cond(react_native_reanimated_1.clockRunning(clock), runSpring),
      ],
      [
